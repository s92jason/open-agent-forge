...
- [Pending] Empty state CTA 行為待 PM 確認（見❓待確認事項 1）
- [Pending] `categorySummary` 是否為 chart aggregation 欄位待 Backend 確認（見❓待確認事項 2）
...
| 檔案 | 用途 |
|----|----|
| 既有 error dialog 元件 | Error state 顯示與 retry |
